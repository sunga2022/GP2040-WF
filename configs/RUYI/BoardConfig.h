...
#define BOARD_CONFIG_LABEL "RUYI"
...
#define GPIO_PIN_19 GpioAction::BUTTON_PRESS_LEFT   // LEFT   | LEFT   | LEFT    | LEFT     | LEFT   | LEFT   |
...
#define GPIO_PIN_00 GpioAction::BUTTON_PRESS_A2     // A2     | ~      | Capture | ~        | 14     | ~      |
#define GPIO_PIN_15 GpioAction::BUTTON_PRESS_FN     // Hotkey Function
...
#define HOTKEY_03_BUTTONS_MASK (GAMEPAD_MASK_S1 | GAMEPAD_MASK_DL)   // FN + S1 + LEFT
#define HOTKEY_03_DPAD_MASK 0
#define HOTKEY_03_ACTION 8  // SOCD LAST WIN

#define HOTKEY_04_AUX_MASK AUX_MASK_FUNCTION
#define HOTKEY_04_BUTTONS_MASK (GAMEPAD_MASK_S1 | GAMEPAD_MASK_DU)   // FN + S1 + UP
