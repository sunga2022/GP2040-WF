...
#define BOARD_CONFIG_LABEL "SUNGA-HUN"
...
#define HOTKEY_00_BUTTONS_MASK (GAMEPAD_MASK_S1 | GAMEPAD_MASK_S2 | GAMEPAD_MASK_DU)   // S1 + S2 + UP = HOME
#define HOTKEY_00_DPAD_MASK 0
#define HOTKEY_00_ACTION 8  // HOME 功能

#define HOTKEY_01_AUX_MASK 0
#define HOTKEY_01_BUTTONS_MASK (GAMEPAD_MASK_S1 | GAMEPAD_MASK_S2 | GAMEPAD_MASK_DD)   // S1 + S2 + DOWN = DP
#define HOTKEY_01_DPAD_MASK 0
#define HOTKEY_01_ACTION 1  // DPAD RIGHT ANALOG

#define HOTKEY_02_AUX_MASK 0
#define HOTKEY_02_BUTTONS_MASK (GAMEPAD_MASK_S1 | GAMEPAD_MASK_S2 | GAMEPAD_MASK_DL)   // S1 + S2 + LS = LS
#define HOTKEY_02_DPAD_MASK 0
#define HOTKEY_02_ACTION 2  // DPAD LEFT ANALOG

#define HOTKEY_03_AUX_MASK 0
#define HOTKEY_03_BUTTONS_MASK (GAMEPAD_MASK_S1 | GAMEPAD_MASK_S2 | GAMEPAD_MASK_DR)   // S1 + S2 + RIGHT = RS
#define HOTKEY_03_DPAD_MASK 0
#define HOTKEY_03_ACTION 3  // DPAD RIGHT ANALOG

#define HOTKEY_04_AUX_MASK 0
#define HOTKEY_04_BUTTONS_MASK (GAMEPAD_MASK_S2 | GAMEPAD_MASK_A1 | GAMEPAD_MASK_DU)   // S2 + A1 + UP
#define HOTKEY_04_DPAD_MASK 0
#define HOTKEY_04_ACTION 6  // SOCD UP PRIORITY

#define HOTKEY_05_AUX_MASK 0
#define HOTKEY_05_BUTTONS_MASK (GAMEPAD_MASK_S2 | GAMEPAD_MASK_A1 | GAMEPAD_MASK_DD)   // S2 + A1 + DOWN
#define HOTKEY_05_DPAD_MASK 0
#define HOTKEY_05_ACTION 7  // SOCD NEUTRAL

#define HOTKEY_06_AUX_MASK 0
#define HOTKEY_06_BUTTONS_MASK (GAMEPAD_MASK_S2 | GAMEPAD_MASK_A1 | GAMEPAD_MASK_DL)   // S2 + A1 + LEFT
#define HOTKEY_06_DPAD_MASK 0
#define HOTKEY_06_ACTION 8  // SOCD LAST WIN
