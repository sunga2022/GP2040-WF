...
主控换成 **WCH CH585**（新塘/沁恒）。这颗芯片同时有：

- USB 2.0 **High Speed**（480 Mbps）→ 有线 **8 kHz**
- BLE 5.4
- 私有 2.4G（官方写了最高 8 kHz 上报）

ESP32-S3 做不到 8 kHz。CH32V307 有 USB HS，但没有射频。CH585 才是同一颗料打三模 + 8k 的选择。
